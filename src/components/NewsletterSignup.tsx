    ...
    <form onSubmit={onSubmit} className="relative flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <input
          ...
          autoComplete="email"
          disabled={submitting}
          className="w-full rounded-xl border border-white/10 bg-white/[0.04] px-4 py-2.5 text-sm text-white outline-none focus:border-brand-400/40 disabled:opacity-60 sm:max-w-xs"
        />
        <Button type="submit" variant="secondary" disabled={!consent || submitting}>
