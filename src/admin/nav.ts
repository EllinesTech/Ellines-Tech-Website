...
export const adminNavGroups: AdminNavGroup[] = [
  {
    ...
    items: [
      ...
      { to: '/admin/visitors', label: 'Visitor Intelligence', icon: 'Globe' },
      ...
      { to: '/admin/chat-settings', label: 'Ellenia Knowledge', icon: 'Bot' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/admin/security', label: 'Security & Password', icon: 'Shield' },
