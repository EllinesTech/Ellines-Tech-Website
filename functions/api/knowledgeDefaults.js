/** Seed data for Knowledge Hub (synced from src/data/knowledge.ts) */
export function defaultKnowledge() {
  return [
  {
    ...
    "excerpt": "How hospitals and clinics can grow digital capacity without fragile, one-off custom builds.",
