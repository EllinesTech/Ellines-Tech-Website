...
function defaultShop() {
  return [
    ...
    },
    {
      ...
      "category": "Design",
      "level": "Starter",
      "description": "Single-page website design — hero, offers, and contact — delivered as design files ready for build.",
      "status": "published",
      "image": "/media/posters/packages/shop_starter_web.jpg",
      "groupId": "design_web",
    ...
    },
    {
      ...
      "category": "Design",
      "level": "Business",
      "description": "Multi-page website design with responsive layouts and brand-aligned visuals — design handoff for development.",
      "status": "published",
      "image": "/media/posters/packages/shop_business_web.jpg",
      "groupId": "design_web",
      "groupName": "Web Design",
    ...
    },
    {
      ...
      "category": "Design",
      "level": "Professional",
      "description": "Website design system — key templates, components, and specs so engineering can ship consistently.",
      "status": "published",
      "image": "/media/posters/packages/shop_uiux.jpg",
      "groupId": "design_web",
      "groupName": "Web Design",
    ...
    },
    {
      ...
      "category": "Design",
      "level": "Starter",
      "description": "Product discovery workshop — problem framing, user flows, information architecture, and prioritised backlog.",
      "status": "published",
      "image": "/media/posters/packages/shop_uiux.jpg",
    ...
    },
    {
      ...
      "category": "Design",
      "level": "Professional",
      "description": "End-to-end product design for a scoped feature set — interaction design through shippable hi-fi screens.",
      "status": "published",
      "image": "/media/posters/packages/shop_uiux.jpg",
      "groupId": "design_product",
      "groupName": "Product Design",
    ...
    },
    {
      ...
      "category": "Design",
      "level": "Enterprise",
      "description": "Full product design engagement — discovery, flows, UI system, and developer-ready handoff.",
      "status": "published",
      "image": "/media/posters/packages/shop_uiux.jpg",
      "groupId": "design_product",
      "groupName": "Product Design",
    ...
    },
    {
      ...
      "category": "Marketing",
      "level": "Starter",
      "description": "Focused strategy workshop — audience, positioning, and campaign priorities for your next push.",
      "status": "published",
      "image": "/media/posters/packages/shop_digital_marketing.jpg",
    ...
    },
    {
      ...
      "category": "Marketing",
      "level": "Business",
      "description": "Go-to-market plan — brand positioning, channel mix, messaging, and a 90-day campaign roadmap.",
      "status": "published",
      "image": "/media/posters/packages/shop_digital_marketing.jpg",
      "groupId": "marketing_strategy",
      "groupName": "Marketing Strategy",
    ...
    },
    {
      ...
      "category": "Marketing",
      "level": "Professional",
      "description": "Multi-quarter growth roadmap — funnel strategy, content pillars, paid/organic mix, and KPI cadence.",
      "status": "published",
      "image": "/media/posters/packages/shop_digital_marketing_growth.jpg",
      "groupId": "marketing_strategy",
      "groupName": "Marketing Strategy",
    ...
    },
    {
      ...
      "category": "Consulting",
      "level": "Starter",
      "description": "Cloud readiness assessment — current stack, migration risks, cost posture, and recommended next steps.",
      "status": "published",
      "image": "/media/posters/packages/consult_tech_roadmap.jpg",
    ...
    },
    {
      ...
      "category": "Consulting",
      "level": "Business",
      "description": "Migration planning package — target architecture, phased cutover, backup/DR notes, and cost estimate bands.",
      "status": "published",
      "image": "/media/posters/packages/consult_tech_roadmap.jpg",
      "groupId": "consulting_cloud",
      "groupName": "Cloud & Infrastructure",
    ...
    },
    {
      ...
      "category": "Consulting",
      "level": "Enterprise",
      "description": "Multi-week infrastructure advisory — reliability, cost/performance tuning, and operating model for scale.",
      "status": "published",
      "image": "/media/posters/packages/consult_it_fullday.jpg",
      "groupId": "consulting_cloud",
      "groupName": "Cloud & Infrastructure",
