...
export function defaultProducts() {
  return [
  {
    ...
    "description": "MedFlow streamlines patient registration, billing, pharmacy, laboratory, and clinical workflows for hospitals and clinics across Africa.",
    "features": [
  ...
  },
  {
    ...
    "description": "AfyaVox assists clinicians with voice-powered documentation, clinical decision support, and patient communication.",
    "features": [
  ...
  },
  {
    ...
    "description": "RV22 is Ellines Tech's flagship AI assistant for businesses — automating support, workflows, and knowledge retrieval.",
    "features": [
  ...
  },
  {
    ...
    "description": "Juno4 is Ellines Tech’s AI platform for modern African businesses — intelligent automation, decision support, and digital operations powered by AI.",
    "features": [
  ...
  },
  {
    ...
    "description": "Lmar brand identity designed by Ellines Tech — professional mark with slogan lockup ready for digital and print.",
    "features": [
      "Logo lockup",
      "Slogan integration",
      "Brand guidelines",
